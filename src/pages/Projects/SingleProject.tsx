...
const SingleProject = () => {
	...
	return (
		<div className="col-[2/5] font-manrope row-[1/7] p-10 bg-gray-100 border-rose-300 border-opacity-50 border-r-[10px] rounded-[50px] shadow-2xl ">
			<div className="">
				<div className="flex justify-between items-center">
					<h1 className="text-[40px]  uppercase font-semibold tracking-[10px]">{projectData.name}</h1>
					<img src={`/${projectData.framework}.png`} alt={projectData.framework} className="w-[128px] h-[128px]" />
				</div>
				<div className="">
					<p className="mt-[-40px] text-gray-400 opacity-50">
